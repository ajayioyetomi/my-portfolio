<script setup>
    import { ref } from 'vue';
    import {Switch,Socials,Menu} from '.';
...
<template>
    <header class="fixed z-50 items-center w-screen top-0 left-0 flex py-[10px] px-[5%] bg-[rgba(244,244,250,0.9)] dark:bg-[rgba(4,1,21,0.9)]">
        <span class="absolute top-0 left-0 w-full h-full -z-0 backdrop-blur-sm"></span>
        ...
        <nav class="relative flex flex-1 justify-end gap-4 sm:gap-6 items-center">
            <div class="hidden gap-4 sm:gap-6 md:flex items-center">
                <a class="relative font-bold text-dark-primary dark:text-primary transition-all duration-75 after:absolute after:w-full after:h-1 after:bg-primary after:inline-block after:content-[''] after:-bottom-2 after:left-0 after:opacity-0 hover:after:opacity-100 " 
